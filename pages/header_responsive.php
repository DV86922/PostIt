...
<header class="header">
    ...
    <nav class="nav-md">
        <ul class="menu-nav">
            ...
            <li class="menu-nav__item">
                <a href="dagen/dag.php?Naam=<?= $Naam ?>&Dag=2" class="menu-nav__link" id="di">Dinsdag</a>
            </li>
            <li class="menu-nav__item">
                <a href="dagen/dag.php?Naam=<?= $Naam ?>&Dag=3" class="menu-nav__link" id="wo">Woensdag</a>
            </li>
            <li class="menu-nav__item">
                <a href="dagen/dag.php?Naam=<?= $Naam ?>&Dag=4" class="menu-nav__link" id="do">Donderdag</a>
            </li>
            <li class="menu-nav__item">
                <a href="dagen/dag.php?Naam=<?= $Naam ?>&Dag=5" class="menu-nav__link" id="vrij">Vrijdag</a>
            </li>
            <li class="menu-nav__item">
                <a href="dagen/dag.php?Naam=<?= $Naam ?>&Dag=6" class="menu-nav__link" id="zat">Zaterdag</a>
            </li>
            <li class="menu-nav__item">
    ...
    <nav class="nav-sm">
        <ul class="menu-nav">
            ...
            <li class="menu-nav__item">
                <a href="dagen/dag.php?Naam=<?= $Naam ?>&Dag=2" class="menu-nav__link" id="di">Di</a>
            </li>
            <li class="menu-nav__item">
                <a href="dagen/dag.php?Naam=<?= $Naam ?>&Dag=3" class="menu-nav__link" id="wo">Wo</a>
            </li>
            <li class="menu-nav__item">
                <a href="dagen/dag.php?Naam=<?= $Naam ?>&Dag=4" class="menu-nav__link" id="do">Do</a>
            </li>
            <li class="menu-nav__item">
                <a href="dagen/dag.php?Naam=<?= $Naam ?>&Dag=5" class="menu-nav__link" id="vrij">Vr</a>
            </li>
            <li class="menu-nav__item">
                <a href="dagen/dag.php?Naam=<?= $Naam ?>&Dag=6" class="menu-nav__link" id="zat">Za</a>
            </li>
            <li class="menu-nav__item">
